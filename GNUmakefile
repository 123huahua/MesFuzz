...
ifdef DEBUG
  ...
  CFLAGS ?= -O3 -funroll-loops $(CFLAGS_OPT)#取消编译优化，便于调试 -O3是优化， -O0是不优化 yyy
endif
...
src/afl-performance.o : $(COMM_HDR) src/afl-performance.c include/hash.h#取消编译优化，下面一行原本是-O3 yyy
	$(CC) $(CFLAGS) -Iinclude $(SPECIAL_PERFORMANCE) -O3 -fno-unroll-loops -c src/afl-performance.c -o src/afl-performance.o

src/afl-mesfuzz-dar.o : $(COMM_HDR) src/afl-mesfuzz-dar.c
	$(CC) $(CFLAGS) $(CFLAGS_FLTO) -c src/afl-mesfuzz-dar.c -o src/afl-mesfuzz-dar.o

src/afl-darwin-rand.o : $(COMM_HDR) src/afl-darwin-rand.c
	$(CC) $(CFLAGS) $(CFLAGS_FLTO) -c src/afl-darwin-rand.c -o src/afl-darwin-rand.o
...
afl-fuzz: $(COMM_HDR) include/afl-fuzz.h  $(AFL_FUZZ_FILES) src/afl-mesfuzz-dar.o src/afl-common.o src/afl-sharedmem.o src/afl-forkserver.o src/afl-performance.o | test_x86
	$(CC) $(CFLAGS) $(COMPILE_STATIC) $(CFLAGS_FLTO) $(AFL_FUZZ_FILES) src/afl-mesfuzz-dar.o src/afl-common.o src/afl-sharedmem.o src/afl-forkserver.o src/afl-performance.o -o $@ $(PYFLAGS) $(LDFLAGS) -lm
